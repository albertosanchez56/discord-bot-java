 ...
 * service and the JDA client. No privileged intents
 * (no {@code MESSAGE_CONTENT}, no {@code GUILD_MEMBERS}): only
 * {@link GatewayIntent#GUILD_VOICE_STATES} is required.
 */
public final class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JDA jda = JDABuilder.createLight(token, GatewayIntent.GUILD_VOICE_STATES)
                ...
                .addEventListeners(registry, router, voiceListener)
                .build()
                .awaitReady();
        ...
        log.info("BertiniBot V2 online as {} | {} command(s) | filter terms: {}",
                jda.getSelfUser().getName(), commands.size(), filter.blockedTerms());
    }
